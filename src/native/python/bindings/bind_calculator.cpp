...
#define DEF_BIN_OP(name)                                                                           \
    .def(#name, py::overload_cast<double, double>(&C::name, py::const_), py::arg("a"),             \
         py::arg("b"))                                                                             \
...
#define DEF_BIG_BIN_OP(name)                                                                       \
    .def(#name, py::overload_cast<const B &, const B &>(&C::name, py::const_), py::arg("a"),       \
         py::arg("b"))
...
#define DEF_UNARY_UNIT_OP(name)                                                                    \
    ...
    py::class_<C>(m, "Calculator")
        .def(py::init<>()) DEF_BIN_OP(add) DEF_BIG_BIN_OP(add) DEF_BIN_OP(sub) DEF_BIG_BIN_OP(sub)
        .def(
            "mul",
        ...
        .def("mul", py::overload_cast<const B &, const B &>(&C::mul, py::const_), py::arg("a"),
             py::arg("b"))
        .def(
            "div",
            [](const C &calc, double a, double b) -> py::object {
        ...
        .def("div", py::overload_cast<const B &, const B &>(&C::div, py::const_), py::arg("a"),
             py::arg("b")) DEF_REAL_BIN_OP(intdiv) DEF_BIG_BIN_OP(intdiv) DEF_REAL_BIN_OP(mod)
            DEF_BIG_BIN_OP(mod)
        .def(
            "pow",
        ...
        .def("pow", py::overload_cast<const B &, const B &>(&C::pow, py::const_), py::arg("a"),
             py::arg("b")) DEF_UNARY_OP(sqrt) DEF_BIG_UNARY_OP(sqrt) DEF_REAL_UNARY_OP(cbrt)
            DEF_BIN_OP(root) DEF_BIG_BIN_OP(root) DEF_UNARY_UNIT_OP(sin) DEF_UNARY_UNIT_OP(cos)
                DEF_UNARY_UNIT_OP(tan) DEF_UNARY_OP(sinh) DEF_UNARY_OP(cosh) DEF_UNARY_OP(tanh)
                    DEF_UNARY_UNIT_OP(asin) DEF_UNARY_UNIT_OP(acos) DEF_UNARY_UNIT_OP(atan)
                        DEF_UNARY_OP(asinh) DEF_UNARY_OP(acosh) DEF_UNARY_OP(atanh)
                            DEF_UNARY_UNIT_OP(polar) DEF_UNARY_OP(log) DEF_BIG_UNARY_OP(log)
                                DEF_UNARY_OP(ln) DEF_BIG_UNARY_OP(ln)
        .def(
            "fact",
            ...
            py::arg("a")) DEF_BIG_UNARY_OP(fact)
        .def(
            "gamma",
            [](const C &calc, double a) -> py::object {
            ...
            py::arg("a")) DEF_BIG_UNARY_OP(gamma)
