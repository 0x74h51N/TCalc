...
SHIFTED_KEYS = {
    ...
    Operation.MOD: {"label": INTDIV_LABEL, "operation": Operation.INTDIV, "tooltip": "integer division"},
    Operation.PERMUTE: {"label": Operation.CHOOSE.symbol, "operation": Operation.CHOOSE, "tooltip": "n choose m"},
    ...
    Operation.RECIP: {"label": EXP10_LABEL, "operation": Operation.EXP10, "row": 6, "col": 1, "tooltip": "exp 10"},
}
...
FUNCTION_KEYS = [
    ...
    {"label": Operation.PERMUTE.symbol, "operation": Operation.PERMUTE, "row":1, "col":1, "tooltip":"n permute m", "shifted":SHIFTED_KEYS[Operation.PERMUTE]},
    ...
    {"label": RECIP_LABEL, "operation": Operation.RECIP, "row": 3, "col": 1, "tooltip": "reciprocal", "shifted": SHIFTED_KEYS[Operation.RECIP]},
]

POWER_KEYS = [
    {"label": SQR_LABEL, "operation": Operation.SQR, "row": 4, "col": 1, "tooltip": "square", "shifted": SHIFTED_KEYS[Operation.SQR]},
    {"label": SQRT_LABEL, "operation": Operation.SQRT, "row": 5, "col": 1, "tooltip": "square root", "shifted": SHIFTED_KEYS[Operation.SQRT]},
    {"label": POW_LABEL, "operation": Operation.POW, "row": 6, "col": 1, "tooltip": "power", "shifted": SHIFTED_KEYS[Operation.POW]},
